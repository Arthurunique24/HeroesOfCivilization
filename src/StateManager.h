...
void StateManager::registerState(States::ID stateID)
{
    ...
    {
        return State::Ptr(std::make_unique<T>(*this, context)); // make_unique должна быть взята из /Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX10.11.sdk
    };
}